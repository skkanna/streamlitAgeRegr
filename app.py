...
def age_pred(is_installed, is_active, longitude, latitude,
                                      device_model, phone_brand, category, gender):
    ...
    """
    prediction=regressor.predict([[is_installed, is_active, longitude, latitude,
                                      device_model, phone_brand, category, gender]])
    print(prediction)
    return prediction
...
def main():
    ...
    <h2 style="color:white;text-align:center;">Streamlit Age Predictor ML App </h2>
    </div>
    """
...
#    v = st.number_input('Test', value=1.)
    ...
    if st.button("Predict"):
        ...
        result=age_pred(is_installed, is_active, longitude, latitude,
                                      device_model, phone_brand, category, gender)
